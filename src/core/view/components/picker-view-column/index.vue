...
export default {
  ...
  methods: {
    _setItemHeight (height) {
      ...
      style.innerText = `.c-picker-view-content.${this.scope}>*{height: ${height}px;overflow: hidden;}`
  ...
  render (createElement) {
    ...
    return createElement('c-picker-view-column', {
      on: {
        tap: this._handleTap
      }
    },
    [
      createElement('div', {
        ref: 'main',
        staticClass: 'c-picker-view-group'
      },
      [
        createElement('div', {
          ref: 'mask',
          staticClass: 'c-picker-view-mask',
        ...
        createElement('div', {
          ref: 'content',
          staticClass: 'c-picker-view-content',
          class: this.scope,
...
.c-picker-view-indicator:after,
.c-picker-view-indicator:before {
  content: " ";
  position: absolute;
  left: 0;
  right: 0;
