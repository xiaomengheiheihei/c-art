<template>
  <c-slider
    ...
    <div class="c-slider-wrapper">
      <div class="c-slider-tap-area">
        <div
          :style="setBgColor"
          class="c-slider-handle-wrapper">
          <div
            ref="c-slider-handle"
            :style="setBlockBg"
            class="c-slider-handle" />
          <div
            :style="setBlockStyle"
      ...
      <span
        v-show="showValue"
        class="c-slider-value">{{ sliderValue }}</span>
    </div>
    <slot />
  </c-slider>
</template>
...
export default {
  ...
  mounted () {
    this.touchtrack(this.$refs['c-slider-handle'], '_onTrack')
  },
  created () {
...
<style>
	...
	c-slider .c-slider-tap-area {
		-webkit-flex: 1;
		flex: 1;
		padding: 8px 0;
	}

	c-slider .c-slider-handle-wrapper {
		position: relative;
		height: 2px;
		border-radius: 5px;
	...
	c-slider .c-slider-handle,
	c-slider .c-slider-thumb {
		position: absolute;
		left: 50%;
		top: 50%;
		cursor: pointer;
	...
	c-slider .c-slider-disabled .c-slider-track {
		background-color: #ccc;
	}

	c-slider .c-slider-disabled .c-slider-thumb {
