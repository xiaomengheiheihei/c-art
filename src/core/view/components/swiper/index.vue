  ...
  render (createElement) {
    ...
    for (let index = 0, length = swiperItems.length; index < length; index++) {
      ...
      slidesDots.push(createElement('div', {
        class: {
          'c-swiper-dot': true,
          'c-swiper-dot-active': (index < currentSync + this.displayMultipleItemsNumber && index >= currentSync) || (index < currentSync + this.displayMultipleItemsNumber - length)
        },
        style: {
    ...
    var slidesWrapperChild = [createElement('div', {
      ...
      'class': 'c-swiper-slides'
    }, [
      createElement('div', {
        ref: 'slideFrame',
        class: 'c-swiper-slide-frame',
    ...
    if (this.indicatorDots) {
      slidesWrapperChild.push(createElement('div', {
        ref: 'slidesDots',
        'class': ['c-swiper-dots', this.vertical ? 'c-swiper-dots-vertical' : 'c-swiper-dots-horizontal']
      }, slidesDots))
    }
...
c-swiper .c-swiper-dots {
  position: absolute;
  font-size: 0;
}

c-swiper .c-swiper-dots-horizontal {
  left: 50%;
  bottom: 10px;
  text-align: center;
  white-space: nowrap;
...
c-swiper .c-swiper-dots-horizontal .c-swiper-dot {
  margin-right: 8px;
}

c-swiper .c-swiper-dots-horizontal .c-swiper-dot:last-child {
  margin-right: 0;
}

c-swiper .c-swiper-dots-vertical {
  right: 10px;
  top: 50%;
  text-align: right;
...
c-swiper .c-swiper-dots-vertical .c-swiper-dot {
  display: block;
  margin-bottom: 9px;
}

c-swiper .c-swiper-dots-vertical .c-swiper-dot:last-child {
  margin-bottom: 0;
}

c-swiper .c-swiper-dot {
