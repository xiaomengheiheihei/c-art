<template>
  ...
  >
    <audio
      ...
      :loop="loop"
      style="display:none;"/>
    <div class="c-audio-default">
      <div
        :style="'background-image: url('+$getRealPath(poster)+');'"
        class="c-audio-left">
        <div
          :class="{play:!playing,pause:playing}"
          class="c-audio-button"
          @click="trigger"/>
      </div>
      <div class="c-audio-right">
        <div class="c-audio-time">{{ currentTime }}</div>
        <div class="c-audio-info">
          <div class="c-audio-name">{{ name }}</div>
          <div class="c-audio-author">{{ author }}</div>
        </div>
      </div>
    </div>
  </c-audio>
