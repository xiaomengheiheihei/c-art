...
export default {
  mounted () {
    if (this.enablePullDownRefresh) {
      ...
      this.refreshControllerElem = this.refreshContainerElem.querySelector('.c-page-refresh')
      this.refreshInnerElemStyle = this.refreshControllerElem.querySelector('.c-page-refresh-inner').style
  ...
  methods: {
    ...
    _toggleClass (type) {
      ...
      if (elem) {
        elem.classList[type]('c-page-refresh--' + this.state)
      }
    },
    _addClass () {
