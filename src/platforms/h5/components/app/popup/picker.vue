<template>
  <c-picker @touchmove.prevent>
    ...
    <div
      :class="{'c-picker-toggle':visible}"
      class="c-picker">
      <div
        class="c-picker-header"
        @click.stop>
        <div
          class="c-picker-action c-picker-action-cancel"
...
c-picker .c-picker.c-picker-toggle {
  visibility: visible;
  transform: translate(0, 0);
}

c-picker .c-picker-content {
  position: relative;
  display: block;
  width: 100%;
  height: 238px;
...
c-picker .c-picker-header:after {
  content: "";
  position: absolute;
  left: 0;
  bottom: 0;
...
c-picker .c-picker-action.c-picker-action-cancel {
  float: left;
  color: #888;
}

c-picker .c-picker-action.c-picker-action-confirm {
  float: right;
  color: #007aff;
}
